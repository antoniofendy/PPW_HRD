    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3">
                ...
                <?php
                    $query = mysqli_query($con, "SELECT * FROM jabatan WHERE id='$_GET[id]'");
                ...
                <div class="card-body">
                    <form method="post" action="jabatanupdate.php">
                        <div class="form-group">
                            <label>ID*</label>
                            <input type="text" class="form-control" name="id" readonly required value="<?= $data['id'] ?>"/>
                        </div>
                        <div class="form-group">
                            <label>Position Name*</label>
                            <input type="text" class="form-control" name="nama" value="<?= $data['nama_jabatan'] ?>" required/>
                        </div>
                        <input type="submit" class="btn btn-outline-info shadow-sm" value="Update">
                        <input type="reset" class="btn btn-outline-warning shadow-sm" value="Reset">
                    </form>
                </div>
